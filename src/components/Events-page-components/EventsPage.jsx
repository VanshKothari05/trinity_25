  ...
  return (
    <div className="events-page bg-gradient-to-r from-black to-red-800 text-white min-h-screen">
      ...
      <div className="text-center py-16 bg-cover bg-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl text-yellow-300 font-bold">
          Events 2025
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {events.map((event) => (
            <a href={event.link} className="block">
              <div className="bg-white bg-opacity-50 rounded-lg text-center p-6 shadow-lg w-full sm:w-96 md:w-112 cursor-pointer">
                <img
                  src={event.image}
                  alt="Cultural Events"
